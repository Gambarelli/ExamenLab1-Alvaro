...
Enemigoverde::Enemigoverde(list<Entidad*>* entidades,SDL_Renderer* renderer) : Enemigo(entidades,renderer)
{
    tipo = "Enemigo verde";
...
void Enemigoverde::logica()
{
    ...
    {
        Proyectilverde *p = new Proyectilverde(entidades,renderer,x,y,state);
